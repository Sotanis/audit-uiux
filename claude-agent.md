...
- `html-template.md` — hướng dẫn xuất báo cáo HTML (ảnh nhúng base64)
...
- Lưu báo cáo vào `~/Downloads/audit-report-[tên-màn-hình]-[YYYY-MM-DD]/` (bao gồm bao-cao.md, bao-cao.html, và ảnh chụp).

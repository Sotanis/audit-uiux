...
|------|---------------|------|
| **Cursor** | `SKILL.md` + 6 file KB | `~/.cursor/skills/audit-uiux/` |
| **Claude Code** | `claude-agent.md` (→ đổi tên thành `audit-uiux.md`) + 6 file KB | `~/.claude/agents/` |
| **Cả hai** | Cả hai bước trên | Cả hai thư mục |

6 file KB: `heuristics.md`, `jtbd-framework.md`, `checklist.md`, `report-template.md`, `html-template.md`, `PHAM-VI-TIEU-CHI-VA-THAM-CHIEU.md`.

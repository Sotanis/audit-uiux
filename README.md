...
|------|---------------|------|
| **Cursor** | `SKILL.md` + 5 file KB | `~/.cursor/skills/audit-uiux/` |
| **Claude Code** | `claude-agent.md` (→ đổi tên thành `audit-uiux.md`) + 5 file KB | `~/.claude/agents/` |
| **Cả hai** | Cả hai bước trên | Cả hai thư mục |

5 file KB: `heuristics.md`, `jtbd-framework.md`, `checklist.md`, `report-template.md`, `PHAM-VI-TIEU-CHI-VA-THAM-CHIEU.md`.
...
- Điểm /100, phân loại P0 / P1 / P2, bằng chứng, đề xuất sửa.

...
| Hạng mục | Điểm | Mức |
|----------|-------|-----|
| A. Cấu trúc | [x]/25 | [Xuất sắc / Tốt / Trung bình / Yếu] |
| B. Hình ảnh | [x]/25 | [Xuất sắc / Tốt / Trung bình / Yếu] |
| C. Tương tác | [x]/25 | [Xuất sắc / Tốt / Trung bình / Yếu] |
| D. Phù hợp mục đích người dùng | [x]/25 | [Xuất sắc / Tốt / Trung bình / Yếu] |
...
[1–2 câu tóm tắt trạng thái thiết kế: sẵn sàng bàn giao, cần sửa nhỏ, hay cần làm lại]
...
|-----|----------|
| **Mức độ** | P0 / P1 / P2 |
| **Hạng mục** | [Phản hồi hiển thị / Nhất quán / Điều hướng / Chữ / Bố cục / Màu sắc / Trạng thái / Ngăn lỗi] |
...
![F-XXX — mô tả ngắn](screenshot-FXXX.png)

- **Mong đợi**: [Mô tả trạng thái thiết kế nên có]
- **Thực tế**: [Mô tả trạng thái thiết kế hiện tại]
...
1. **Bằng chứng**: Mỗi phát hiện phải có ảnh chụp nhúng trực tiếp trong báo cáo. Ảnh lưu cùng thư mục với file báo cáo, đặt tên `screenshot-FXXX.png` (theo mã finding). Ảnh tổng quan đặt tên `screenshot-overview.png`.
